...
__all__ = ["approx_delta_vectorized", "portfolio_greeks_vectorized"]


def _require_numpy() -> None:
    if not HAS_NUMPY:
        msg = "numpy is required for vectorized greeks calculations. Install it with: pip install numpy"
...
def approx_delta_vectorized(
    ...
    return np.where(fallback, fallback_val, raw_delta)
