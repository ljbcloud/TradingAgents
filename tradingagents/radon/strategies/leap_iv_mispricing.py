...
:class:`~tradingagents.radon.strategies.base.BaseStrategy` protocol.
"""
...
class LeapIVStrategy:
    ...
    def is_available(self) -> bool:
        ...
        The check is lightweight: it only verifies that the ``tradingagents``
        ...
        """
        try:
            from tradingagents.radon.clients.ib_client import IBClient  # noqa: F401
