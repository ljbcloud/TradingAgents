...
if TYPE_CHECKING:
    from radon.evaluation.models import EvaluationResult


def is_radon_available() -> bool:
    """Return True when the Radon evaluator can be instantiated."""
    try:
        from radon.evaluation.evaluator import (  # noqa: F401
            RadonEvaluator,
        )
    except ImportError:
        return False
...
def _get_validation_status_unavailable() -> str:
    ...
    """
    try:
        from radon.evaluation.models import ValidationStatus
