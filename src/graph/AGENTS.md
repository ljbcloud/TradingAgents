...
- Write tests in tests/src/graph/
...
uv run pytest tests/src/graph/test_signal_processing.py -v

# Test conditional logic
uv run pytest tests/src/graph/test_conditional_logic.py -v
