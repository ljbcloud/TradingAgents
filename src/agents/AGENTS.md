...
```bash
# Test analyst agents
uv run pytest tests/src/agents/analysts/ -v
...
- Use tools from src/agents/utils/
...
- Write tests in tests/src/agents/analysts/
...
### Project Knowledge
- Researcher agents are in src/agents/researchers/
...
uv run pytest tests/src/agents/researchers/ -v
...
**Always Do:**
- Use `uv run` prefix for all Python commands
- Write tests in tests/src/agents/researchers/
...
### Project Knowledge
- Trader agent is in src/agents/trader/trader.py
...
```bash
# Test trader agent
uv run pytest tests/agents/trader/ -v
...
**Always Do:**
- Use `uv run` prefix for all Python commands
- Write tests in tests/agents/trader/
...
### Project Knowledge
- Risk agents are in src/agents/risk_mgmt/
...
```bash
# Test risk agents
uv run pytest tests/src/agents/risk_mgmt/ -v
...
**Always Do:**
- Use `uv run` prefix for all Python commands
- Write tests in tests/src/agents/risk_mgmt/
