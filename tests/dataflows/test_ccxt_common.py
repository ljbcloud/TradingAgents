...
from dataflows.exceptions import ConfigurationError, VendorError
...
class TestValidateCCXTKey:
    ...
    def test_valid_key_returns_key(self):
        ...
        from dataflows.ccxt_common import validate_ccxt_key
...
class TestGetExchangeCredentials:
    ...
    def test_returns_credentials_from_env(self):
        ...
        from dataflows.ccxt_common import get_exchange_credentials
...
class TestCreateExchange:
    ...
    def test_creates_coinbase_exchange(self):
        ...
        from dataflows.ccxt_common import create_exchange

        mock_exchange = MagicMock()
        mock_exchange.id = "coinbase"

        with patch(
            "dataflows.ccxt_common.ccxt.coinbase",
...
class TestCCXTRateLimitError:
    ...
    def test_is_exception(self):
        ...
        from dataflows.ccxt_common import CCXTRateLimitError
