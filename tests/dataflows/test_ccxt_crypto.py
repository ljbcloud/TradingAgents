...
class TestGetCryptoCandles:
    ...
    @patch("dataflows.ccxt_crypto._get_exchange")
    def test_returns_formatted_csv_string(
        ...
        from dataflows.ccxt_crypto import get_crypto_candles
...
class TestGetCryptoTicker:
    ...
    def test_returns_formatted_ticker_string(
        ...
        from dataflows.ccxt_crypto import get_crypto_ticker
...
class TestGetCryptoOrderbook:
    ...
    def test_returns_formatted_orderbook(
        ...
        from dataflows.ccxt_crypto import get_crypto_orderbook
