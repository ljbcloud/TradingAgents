...
from dataflows.alternative_me import _classify_value  # noqa: PLC2701
...
class TestGetBitcoinFearGreedIndex:
    ...
    @patch("dataflows.alternative_me.requests.get")
    def test_returns_current_value(self, mock_get):
        ...
        # Act
        from dataflows.alternative_me import get_bitcoin_fear_greed_index
