...
class TestAllClientsUnavailable:
    ...
    @patch("radon.evaluation.evaluator.RadonEvaluator._milestone_m4_edge_determination")
    @patch("radon.evaluation.evaluator.RadonEvaluator._milestone_m5_structure_proposal")
    @patch("radon.evaluation.evaluator.RadonEvaluator._milestone_m6_kelly_sizing")
    @patch("radon.evaluation.evaluator.RadonEvaluator._milestone_m7_final_decision")
    @patch("radon.evaluation.evaluator.RadonEvaluator._run_parallel_milestones")
...
class TestKellySizing:
    ...
    @patch("radon.utils.kelly.fractional_kelly")
    ...
    @patch(
        "radon.utils.kelly.fractional_kelly",
...
class TestPartialClientAvailability:
    ...
    @patch("radon.clients.uw_client.UWClient")
    ...
    @patch("radon.strategies.dark_pool_flow.DarkPoolFlowStrategy")
