"""Tests for radon.clients.uw_client module."""
...
def uw_client():
    ...
    with patch("radon.clients.uw_client.HAS_HTTPX", True):
...
class TestUWClientUnavailable:
    ...
    @patch("radon.clients.uw_client.HAS_HTTPX", False)
...
class TestUWClientInit:
    @patch("radon.clients.uw_client.HAS_HTTPX", True)
...
class TestUWExceptionHierarchy:
    def test_uw_api_error_base(self):
        from radon.clients.uw_client import UWAPIError
    ...
    def test_uw_auth_error_inherits(self):
        from radon.clients.uw_client import UWAPIError, UWAuthError
...
class TestUWClientGet:
    ...
    def test_get_raises_auth_error_on_401(self, uw_client, mock_httpx_response):
        from radon.clients.uw_client import UWAuthError
    ...
    def test_get_raises_not_found_on_404(self, uw_client, mock_httpx_response):
        from radon.clients.uw_client import UWNotFoundError
    ...
    def test_get_raises_validation_error_on_422(self, uw_client, mock_httpx_response):
        from radon.clients.uw_client import UWValidationError
    ...
    def test_get_raises_server_error_on_500_after_retries(
        ...
        from radon.clients.uw_client import UWServerError
